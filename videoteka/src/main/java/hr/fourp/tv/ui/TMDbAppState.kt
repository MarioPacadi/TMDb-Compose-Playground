...
class TMDbAppState(val navController: NavHostController) {
    ...
    val navBarTabs = HomeSections.entries.toTypedArray()
    private val navBarRoutes = navBarTabs.map { it.route }
    ...
    fun navigateToNavBarRoute(route: String) {
